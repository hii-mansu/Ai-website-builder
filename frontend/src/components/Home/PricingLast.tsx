...
const PricingLast = () => {
  return (
    <section className="flex mt-[-15px] flex-col items-center justify-center max-md:px-2 w-full text-center py-20 md:py-24 bg-[url('https://raw.githubusercontent.com/prebuiltui/prebuiltui/main/assets/banners/image-2.png')] bg-cover bg-center bg-no-repeat">
                <h1 className="text-2xl md:text-3xl font-medium text-white max-w-2xl">Hear Direct Experiences From Users Who Built Websites Using Mansu’s AI</h1>
                ...
                <p className="text-sm md:text-base text-white max-w-xl">
                    Honest feedback from users sharing their experience creating structured websites using our platform.
                </p>
                <button className="px-10 py-3 mt-4 text-sm bg-white text-blue-600/70 font-semibold hover:scale-105 transition duration-300 rounded-full">
                    View Community Work
                </button>
                <Testimonial/>
            </section>
